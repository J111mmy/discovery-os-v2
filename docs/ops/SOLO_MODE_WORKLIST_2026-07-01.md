...
1. [ ] `theme_evidence=0` investigation, highest value. Procurement Tracking has 16 themes and 23 trusted evidence but 0 `theme_evidence` links. Determine whether the issue is stale data or a live synthesis/linking bug, then file/fix as appropriate.
