...
Write in clear, direct prose. Do not use bullet points unless grouping brief examples. Avoid filler phrases like "it's worth noting" or "the participant mentioned." Attribute quotes to the speaker by name if known, otherwise "the participant."
